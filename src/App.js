...
const App = () => {
  ...
  const [ backgroundUrl, setBackgroundUrl ] = useState("https://images.alphacoders.com/115/1159891.jpg");
  ...
  const getPokemon = async (data) => {
    const filteredData = data?.filter(pokemon => pokemon.name.includes(keyword));
  ...
  return (
    <div id="App">
      ...
      <PokemonGenerations handleBackgroundChange={handleBackgroundChange} handleUrlChange={handleUrlChange} />
      <PokemonContainer handlePokeDexPokemon={handlePokeDexPokemon} pokemonDataList={pokemonDataList} />
